...
#define CONFIG_SPEAR320_MDI		1
/* #define CONFIG_SPEAR320_MDI_DEBUG_UART0 */
 ...
 */
#define CONFIG_DDR_JEDEC_512M_X16_800D 1
 ...
 */
#define CONFIG_MACH_TYPE		(2661)
#define CONFIG_BOOTARGS			\
		"console=ttyAMA0,115200 mem=128M root=/dev/mtdblock3 " \
		"rootfstype=jffs2"

#define CONFIG_NO_CHECK_IMAGE_NAME
...
#define CONFIG_SPEAR_RASMODE		(0xB3000010)
  ...
  #define RASSELDEF			(0xFFFFAC0C) /* enable I2C0, SSP0 SPI, MII0 MAC, enhanced UART0 */
  #define RASMODEDEF		(0x00000042) /* UARTCLK from PCLK, expanded automation mode */
#else
  #define EIGHT_BANK_MODE
  #define RASSELDEF			(0xFFFFAC04) /* enable I2C0, SSP0 SPI, MII0 MAC, basic UART0 */
  #define RASMODEDEF		(0x00000001) /* UARTCLK from RAS_CLK_SYNT2, MII mode */
#endif
